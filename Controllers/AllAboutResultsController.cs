    ...
    public class AllAboutResults : Controller
    {
         ...
         public IActionResult Index()
        {
            ...
            switch (day)
            {
                case "Monday":
                case "Tuesday":
                    ViewData["dayMessage"] = "The work week is just started! stay focused, you have a lot to do this week!";
                    route = 1;
                    break;
                case "Wednesday":
                    ...
                    break;
                case "Thursday":
                    ViewData["dayMessage"] = "I never could get the hang of Thursdays";
                    route = 3;
                    break;
                case "Friday":
